    ...
    <div className="page">
          ...
          <div key={s.n} style={{
            ...
            <div style={{ padding: "16px 18px" }}>
              <div style={{ fontFamily: "'Saans', sans-serif", fontSize: 13, fontWeight: 600,
                color: "var(--black)", marginBottom: 4 }}>{s.name}</div>
              <div style={{ fontFamily: "'Saans', sans-serif", fontSize: 11, fontWeight: 600,
                color: "var(--black)", letterSpacing: "0.06em", marginBottom: 8 }}>{s.hex.toUpperCase()}</div>
      ...
      <div style={{ borderTop: "1px solid #E5E5E5", paddingTop: 40, marginBottom: 56 }}>
        <h3 style={{ fontFamily: "'Saans', sans-serif", fontWeight: 500, fontSize: 17,
          margin: '0 0 24px', color: 'var(--black)' }}>Usage rules</h3>
      ...
      <div style={{ borderTop: "1px solid #E5E5E5", paddingTop: 40 }}>
        <h3 style={{ fontFamily: "'Saans', sans-serif", fontWeight: 500, fontSize: 17,
          margin: '0 0 8px', color: 'var(--black)' }}>Sequential palette</h3>
          ...
          {[100, 80, 60, 40, 20, 10].map(pct => (
            <div key={pct} style={{ flex: 1 }}>
              ...
              <div style={{ fontFamily: "'Saans', sans-serif", fontSize: 10, fontWeight: 600,
                color: "var(--black)", letterSpacing: "0.06em", paddingTop: 8, textAlign: "center" }}>
                {pct}%
              </div>
            </div>
          ))}
