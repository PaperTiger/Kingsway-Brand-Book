...
const rows = [
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 700, fontSize: "clamp(28px,4vw,56px)", lineHeight: 0.95, letterSpacing: "-0.04em", color: "var(--charcoal)" }}>
  ...
  },
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 400, fontSize: "clamp(15px,1.4vw,18px)", lineHeight: 1.4, color: "var(--charcoal)", maxWidth: 560 }}>
  ...
  },
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 400, fontSize: "clamp(14px,1.2vw,16px)", lineHeight: 1.4, color: "var(--charcoal)", maxWidth: 560 }}>
  ...
  return (
    <div className="page">
      ...
      <p className="section-intro">
        When DM Sans is unavailable (system-generated documents, plain-text email environments,
        or contexts where font licensing cannot be guaranteed), <strong>Arial</strong> is the
        designated system fallback. It is not a replacement for DM Sans in branded communications.
      </p>
