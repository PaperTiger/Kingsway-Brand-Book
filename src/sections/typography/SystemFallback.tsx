...
const rows = [
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 700, fontSize: "clamp(28px,4vw,56px)", lineHeight: 0.95, letterSpacing: "-0.04em", color: "var(--black)" }}>
  ...
  },
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 400, fontSize: "clamp(15px,1.4vw,18px)", lineHeight: 1.4, color: "var(--black)", maxWidth: 560 }}>
  ...
  },
  {
    ...
    ex: (
      <div style={{ fontFamily: "Arial, sans-serif", fontWeight: 400, fontSize: "clamp(14px,1.2vw,16px)", lineHeight: 1.4, color: "var(--black)", maxWidth: 560 }}>
