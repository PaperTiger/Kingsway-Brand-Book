    ...
    <div className="page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, marginBottom: 48 }}>
        ...
        <div style={{ background: '#F8F8F8', padding: '40px 36px' }}>
          <div style={{ fontFamily: `${bf}, sans-serif`, fontWeight: 400, fontSize: 'clamp(40px,6vw,72px)', color: 'var(--black)', lineHeight: 0.9, marginBottom: 24 }}>Aa</div>
          <div style={{ fontFamily: `${bf}, sans-serif`, fontSize: 11, color: 'var(--black)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 6 }}>Body & UI</div>
          <div style={{ fontFamily: `${bf}, sans-serif`, fontSize: 20, fontWeight: 600, color: 'var(--black)' }}>{bf}</div>
        </div>
      </div>
      <p style={{ fontFamily: `${bf}, sans-serif`, fontSize: 15, lineHeight: 1.7, color: 'var(--black)', maxWidth: 560 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, marginTop: 32, padding: '16px 20px', background: '#F4F6F8', borderLeft: '3px solid #082C48', maxWidth: 560 }}>
        ...
        <p style={{ fontFamily: `${bf}, sans-serif`, fontSize: 13, lineHeight: 1.5, color: 'var(--black)', margin: 0 }}>
