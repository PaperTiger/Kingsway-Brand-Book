  ...
  return (
    <div className="photo-layout">
      <div>
        ...
        <p style={{ fontFamily: "Saans, sans-serif", fontSize: 14, color: "#111", lineHeight: 1.6 }}>
        ...
        {items.map(item => (
          <div key={item.seed} style={{ paddingBottom: 40 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div style={{ fontFamily: "Saans, sans-serif", fontSize: 13, color: "#111", lineHeight: 1.5 }}>{item.caption}</div>
            </div>
          </div>
        ))}
      </div>
