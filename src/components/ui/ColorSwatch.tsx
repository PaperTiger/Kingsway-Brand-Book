  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
        ...
        <span style={{ fontFamily: "'Saans', sans-serif", fontSize: 16, fontWeight: 600, color: textColor, letterSpacing: '0.02em', lineHeight: 1 }}>{color.name}</span>
      </div>
      <div style={{ fontFamily: "'Saans', sans-serif", fontSize: 11, color: textColor, display: 'grid', gridTemplateColumns: '14px 1fr', gap: '0 10px', lineHeight: 1.1, opacity: 0.92, fontWeight: 500 }}>
        ...
        <div>
          <button
            onClick={copyHex}
            style={{ fontFamily: "'Saans', sans-serif", fontSize: 11, color: textColor, background: pillBg, border: 'none', cursor: 'pointer', padding: '2px 8px', borderRadius: 999, display: 'inline-flex', alignItems: 'center', gap: 5, letterSpacing: '0.03em', fontWeight: 600 }}
            title="Copy hex"
          >
            {hexVal}
        ...
        {color.pantone && (
          <>
            <div style={{ gridColumn: '1/-1', height: 7 }} />
            <span>P</span>
            <span style={{ letterSpacing: '0.01em' }}>{color.pantone.replace(/^P\s+/, '')}</span>
          </>
        )}
      </div>
    </div>
